...
christmas() {
    ...
    CURRENT_CHRISTMAS=$(date -jf "%H:%M:%S %b %d %Z %Y" "23:59:59 $CHRISTMAS_DAYMONTH $CURRENT_TIMEZONE $CURRENT_YEAR" "+%s")
    TODAY=$(date +%s)
    ...
    CHRISTMAS=$(date -jf "%H:%M:%S %b %d %Z %Y" "23:59:59 $CHRISTMAS_DAYMONTH $CURRENT_TIMEZONE $COUNTDOWN_YEAR" "+%s")
