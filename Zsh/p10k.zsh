# Generated by Powerlevel10k configuration wizard on 2021-06-29 at 08:57 EDT.
...
() {
  ...
  # Stashes Icon. It was originally an asterisk but I added this custom icon instead.
  # Change the value of this parameter to show a different icon.
  typeset -g POWERLEVEL9K_VCS_STASHES_ICON='\uf692'

  # Unstaged Changes Icon. It was originally an exclamation but I added this custom icon instead.
  # Change the value of this parameter to show a different icon.
  typeset -g POWERLEVEL9K_VCS_UNSTAGED_ICON='\uf06a'

  # Staged Changes Icon. It was originally an exclamation but I added this custom icon instead.
  # Change the value of this parameter to show a different icon.
